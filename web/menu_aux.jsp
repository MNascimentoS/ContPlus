    ...
    <body>  
        ...
        <aside id="left-sidebar-nav">
            <ul id="slide-out" class="side-nav fixed leftside-navigation">
                ...
                <li class="bold"><a href="cad_lancamento.jsp" class="waves-effect waves-cyan"><i class="material-icons">add</i> Novo Lançamento</a></li>
                <li class="bold"><a href="gerar_balanco.jsp" class="waves-effect waves-cyan"><i class="material-icons">list</i> Gerar Balanço Patrimonial</a></li>
            </ul>
