...
<head>
    ...
    <meta name="description" content="Pagina Erro 500. ">
    <meta name="keywords" content="sonaes, uneb">
    <title>ERRO 500 | Sonaes - Sistema Online de Acompanhamento Estudantil</title>
    <!-- Favicons-->
                    ...
                    <div class="content">
                        <div class="row">
                            <div id="site-layout-example-top" class="col s12">
                                <p class="flat-text-logo center white-text caption-uppercase">ERRO INTERNO DO SERVIDOR :(</p>
                            </div>
                            <div id="site-layout-example-right" class="col s12 m12 l12">
                                ...
                                <div class="row center">
                                    <p class="center white-text col s12">Algo muito errado aconteceu... Por favor tente depois.</p>
